...
sed -i 's/^phone\s*=.*$/phone = **************/g' lib/miningtools.ini
sed -i 's/^contact\s*=.*$/contact = **************/g' lib/miningtools.ini
...
rm -f puppet/modules/site.pp
rm -f puppet/modules/gpuminer/files/AMD-APP-SDK-v2.9-lnx64.tgz
rm -f puppet/modules/gpuminer/files/amd-catalyst-13.12-linux-x86.x86_64.run
rm -f puppet/modules/gpuminer/files/amd-driver-installer-14.10.1006-x86.x86_64.zip
rm -f puppet/modules/gpuminer/files/amd-driver-installer-14.10.1006-x86.x86_64.run
